...
To scrape the individuals sections in the website, use the function [`scrape_eclds()`](../reference/scrape_eclds.html). The code below scrapes the tables in the Early Care and Education subsection in Kindergarten section for each county between the school years 2018 and 2020.
